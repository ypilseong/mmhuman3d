...
def multi_person_with_mmtracking(args, frames_iter, mesh_model, extractor, client_socket):
    ...
    # 서버에 연결
        ...
        while True:
            ...
            if args.multi_person_demo:
                multi_person_with_mmtracking(args, frames_iter, mesh_model, extractor, client_socket)
            else:
